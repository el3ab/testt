...
static const int64_t nTargetTimespan = 240 * 60;  // testt - every 4 hour
unsigned int nTargetSpacing = 1 * 60; // testt - 1 minute
static const int64_t nInterval = nTargetTimespan / nTargetSpacing;

static const int64_t nDiffChangeTarget = 1;

unsigned int nStakeMinAge = 8 * 60 * 60; // testt - 8 hours
unsigned int nStakeMaxAge = 1440 * 60; // testt - 24 hours
unsigned int nModifierInterval = 10 * 60; // testt - time to elapse before new modifier is computed
...
const string strMessageMagic = "testt Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "testt", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "this is only a test";
        CTransaction txNew;
        txNew.nTime = 1425656013;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1425656013;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 224210 : 224210;


        assert(block.hashMerkleRoot == uint256("0x0a7f6bcaa987b037f59aed9b52b064ed7d96d84319c78194d40db1b4d8c99f1f"));
...
unsigned char pchMessageStart[4] = { 0xa4, 0xd1, 0xd3, 0xa1 };
